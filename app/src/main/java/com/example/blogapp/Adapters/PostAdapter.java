...
//        Log.d(TAG, "Adapter" +Constant.URL+"storage/profiles/"+post.getPhoto());
        ...
        else {holder.btnPostOptions.setVisibility(View.GONE);}
...
//                    return false;
    ...
    private void deletePost(int postId, int position) {
        ...
        buider.setTitle("Xác nhận ");
        buider.setMessage("Xoá bài viết này?");
        buider.setPositiveButton("Xoá", new DialogInterface.OnClickListener() {
        ...
        buider.setNegativeButton("Huỷ", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
